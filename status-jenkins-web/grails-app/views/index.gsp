...
<html lang="en" class="no-js">
	...
	<form class="form-horizontal">
		 ...
		 <div class="alert alert-success" role="alert" id='msgSucess' style="display:none;">
  			<strong>Sucesso!</strong> O projeto esta configurado!!
		 </div>
		 <!-- Text input-->
		 <div class="form-group">
		     <label class="col-md-4 control-label" for="textinputUrl">Url*</label>  
		     <div class="col-md-6">
		     <input id="textinputUrl" name="textinputUrl" type="text" placeholder="Ex: ./Projeto1/api/json" class="form-control input-md" required="">
